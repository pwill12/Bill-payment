...
import { RewardsCard } from "@/utils/data";
...
const rewards = () => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-teal-100 rounded-b-3xl" style={{maxHeight: height*0.265}}>
      <View className="p-3 gap-4">
        ...
        <View className="">
          <CategoryActions type={RewardsCard}  styles={categorystyle.none} rewardstyle/>
        </View>
      </View>
    </SafeAreaView>
  );
